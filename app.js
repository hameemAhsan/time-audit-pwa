(() => {
  ...
  function renderAddScreen() {
    ...
    const formValues = editing || {
      ...
      startTime: preset ? minutesToTime(preset.start) : latestLog?.endTime || '09:00',
      endTime: preset ? minutesToTime(preset.end) : minutesToTime(Math.min(24 * 60, timeToMinutes(latestLog?.endTime || '09:00') + 60)),
